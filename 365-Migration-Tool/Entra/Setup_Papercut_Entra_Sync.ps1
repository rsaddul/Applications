...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        Title="PaperCut Entra ID App Registration"
    ...
    <Grid Margin="10">
        ...
        <TextBlock Text="PaperCut Entra ID App Registration Tool"
...
$startButton.Add_Click({
    ...
    $appName = "PaperCut Entra ID Sync"
    $redirectUris = @("http://localhost:9191/api/oauth2callback")
