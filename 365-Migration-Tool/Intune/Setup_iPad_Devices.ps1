...
if ($SetupType -in @("Trust","School")) {
    $staticGroups += @(
        "[EDU v2 Security] - $SchoolCode All Corporate iPad Devices",
        "[EDU v2 Security] - $SchoolCode All Corporate Shared iPad Devices",
        "[EDU v2 Security] - $SchoolCode All Corporate Personal iPad Devices",
        "[EDU v2 Security] - $SchoolCode Student Shared iPad Enrolment",
        "[EDU v2 Security] - $SchoolCode Student Personal iPad Enrolment",
        "[EDU v2 Security] - $SchoolCode Staff Shared iPad Enrolment",
        "[EDU v2 Security] - $SchoolCode Staff Personal iPad Enrolment"
    )
}
if ($SetupType -eq "Trust" -and $TrustCode) {
    $staticGroups += @(
        "[EDU v2 Security] - $TrustCode All Corporate iPad Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Shared iPad Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Shared Staff iPad Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Shared Student iPad Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Personal iPad Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Personal Staff iPad Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Personal Student iPad Devices"
    )
}
...
if ($SetupType -in @("Trust","School")) {
    $dynamicGroups += @(
        "[EDU v2 Security] - $SchoolCode All Staff Corporate Personal iPad Devices",
        "[EDU v2 Security] - $SchoolCode All Student Corporate Personal iPad Devices",
        "[EDU v2 Security] - $SchoolCode All Staff Corporate Shared iPad Devices",        
        "[EDU v2 Security] - $SchoolCode All Student Corporate Shared iPad Devices"
    )
}
...
foreach ($dynamicGroupName in $dynamicGroups) {
    ...
    $membershipRule = switch ($dynamicGroupName) {
        "[EDU v2 Security] - $SchoolCode All Staff Corporate Shared iPad Devices"   { "(device.enrollmentProfileName -eq ""[EDU v2 Security] - $SchoolCode Staff Shared iPad Enrolment"")" }
        "[EDU v2 Security] - $SchoolCode All Student Corporate Shared iPad Devices" { "(device.enrollmentProfileName -eq ""[EDU v2 Security] - $SchoolCode Student Shared iPad Enrolment"")" }
        "[EDU v2 Security] - $SchoolCode All Staff Corporate Personal iPad Devices" { "(device.enrollmentProfileName -eq ""[EDU v2 Security] - $SchoolCode Staff Personal iPad Enrolment"")" }
        "[EDU v2 Security] - $SchoolCode All Student Corporate Personal iPad Devices" { "(device.enrollmentProfileName -eq ""[EDU v2 Security] - $SchoolCode Student Personal iPad Enrolment"")" }
    }
    if ($membershipRule) {
...
if ($SetupType -eq "Trust" -and $TrustCode) {
    $trustAllCorp         = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate iPad Devices").Id
    $trustAllPersonal     = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Personal iPad Devices").Id
    $trustAllShared       = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Shared iPad Devices").Id
    $trustStaffPersonal   = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Personal Staff iPad Devices").Id
    $trustStaffShared     = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Shared Staff iPad Devices").Id
    $trustStudentPersonal = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Personal Student iPad Devices").Id
    $trustStudentShared   = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Shared Student iPad Devices").Id
}
if ($SetupType -in @("Trust","School")) {
    $schoolAllCorp         = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Corporate iPad Devices").Id
    $schoolAllPersonal     = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Corporate Personal iPad Devices").Id
    $schoolAllShared       = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Corporate Shared iPad Devices").Id
    $schoolStaffPersonal   = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Staff Corporate Personal iPad Devices").Id
    $schoolStaffShared     = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Staff Corporate Shared iPad Devices").Id
    $schoolStudentPersonal = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Student Corporate Personal iPad Devices").Id
    $schoolStudentShared   = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Student Corporate Shared iPad Devices").Id
}
