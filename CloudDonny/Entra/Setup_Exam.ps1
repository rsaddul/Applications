...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="10">
        ...
        <TextBlock Text="Exam Users Query Tool"
...
$appId = [ref]""; $clientSecretVal = [ref]""; $tenantId = [ref]""
...
$startButton.Add_Click({
    ...
    $appName = "Exam Users Query"
    $graphAppId = "00000003-0000-0000-c000-000000000000" # Graph API
    ...
    try {
        ...
        Write-Log "App created with ID: $($app.Id)"
        ...
        $permissions = @("GroupMember.Read.All","User.Read.All")
        ...
        Write-Log "Opening admin consent URL in InPrivate..."
        Write-Log " → $consentUrl"
        Start-Process "msedge.exe" -ArgumentList "--inprivate", $consentUrl

        Write-Log "Creating client secret..."
        $secret = Add-MgApplicationPassword -ApplicationId $app.Id -PasswordCredential @{ DisplayName = "ExamQuerySecret"; EndDateTime = (Get-Date).AddYears(2) }
