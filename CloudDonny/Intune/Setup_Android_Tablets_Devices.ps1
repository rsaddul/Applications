...
"🔹 Running Android Tablet Groups setup..."
...
"   - [EDU v2 Security] - $SchoolCode Student Shared Android Tablet Enrolment"
"   - [EDU v2 Security] - $SchoolCode Student Personal Android Tablet Enrolment"
"   - [EDU v2 Security] - $SchoolCode Staff Shared Android Tablet Enrolment"
"   - [EDU v2 Security] - $SchoolCode Staff Personal Android Tablet Enrolment"

# --- Static Groups ---
$staticGroups = @()
if ($SetupType -in @("Trust","School")) {
    $staticGroups += @(
        "[EDU v2 Security] - $SchoolCode All Corporate Android Tablet Devices",
        "[EDU v2 Security] - $SchoolCode All Corporate Shared Android Tablet Devices",
        "[EDU v2 Security] - $SchoolCode All Corporate Personal Android Tablet Devices",
        "[EDU v2 Security] - $SchoolCode Student Shared Android Tablet Enrolment",
        "[EDU v2 Security] - $SchoolCode Student Personal Android Tablet Enrolment",
        "[EDU v2 Security] - $SchoolCode Staff Shared Android Tablet Enrolment",
        "[EDU v2 Security] - $SchoolCode Staff Personal Android Tablet Enrolment"
...
if ($SetupType -eq "Trust" -and $TrustCode) {
    $staticGroups += @(
        "[EDU v2 Security] - $TrustCode All Corporate Android Tablet Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Shared Android Tablet Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Shared Staff Android Tablet Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Shared Student Android Tablet Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Personal Android Tablet Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Personal Staff Android Tablet Devices",
        "[EDU v2 Security] - $TrustCode All Corporate Personal Student Android Tablet Devices"
    )
}
...
if ($SetupType -in @("Trust","School")) {
    $dynamicGroups += @(
        "[EDU v2 Security] - $SchoolCode All Staff Corporate Personal Android Tablet Devices",
        "[EDU v2 Security] - $SchoolCode All Student Corporate Personal Android Tablet Devices",
        "[EDU v2 Security] - $SchoolCode All Staff Corporate Shared Android Tablet Devices",
        "[EDU v2 Security] - $SchoolCode All Student Corporate Shared Android Tablet Devices"
    )
}
foreach ($dynamicGroupName in $dynamicGroups) {
    ...
    $membershipRule = switch ($dynamicGroupName) {
        "[EDU v2 Security] - $SchoolCode All Staff Corporate Shared Android Tablet Devices"   { "(device.enrollmentProfileName -eq ""[EDU v2 Security] - $SchoolCode Staff Shared Android Tablet Enrolment"")" }
        "[EDU v2 Security] - $SchoolCode All Student Corporate Shared Android Tablet Devices" { "(device.enrollmentProfileName -eq ""[EDU v2 Security] - $SchoolCode Student Shared Android Tablet Enrolment"")" }
        "[EDU v2 Security] - $SchoolCode All Staff Corporate Personal Android Tablet Devices" { "(device.enrollmentProfileName -eq ""[EDU v2 Security] - $SchoolCode Staff Personal Android Tablet Enrolment"")" }
        "[EDU v2 Security] - $SchoolCode All Student Corporate Personal Android Tablet Devices" { "(device.enrollmentProfileName -eq ""[EDU v2 Security] - $SchoolCode Student Personal Android Tablet Enrolment"")" }
    }
    if ($membershipRule) {
...
# --- Resolve IDs ---
if ($SetupType -eq "Trust" -and $TrustCode) {
    $trustAllCorp         = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Android Tablet Devices").Id
    $trustAllPersonal     = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Personal Android Tablet Devices").Id
    $trustAllShared       = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Shared Android Tablet Devices").Id
    $trustStaffPersonal   = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Personal Staff Android Tablet Devices").Id
    $trustStaffShared     = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Shared Staff Android Tablet Devices").Id
    $trustStudentPersonal = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Personal Student Android Tablet Devices").Id
    $trustStudentShared   = (Get-GroupByName "[EDU v2 Security] - $TrustCode All Corporate Shared Student Android Tablet Devices").Id
}
if ($SetupType -in @("Trust","School")) {
    $schoolAllCorp         = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Corporate Android Tablet Devices").Id
    $schoolAllPersonal     = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Corporate Personal Android Tablet Devices").Id
    $schoolAllShared       = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Corporate Shared Android Tablet Devices").Id
    $schoolStaffPersonal   = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Staff Corporate Personal Android Tablet Devices").Id
    $schoolStaffShared     = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Staff Corporate Shared Android Tablet Devices").Id
    $schoolStudentPersonal = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Student Corporate Personal Android Tablet Devices").Id
    $schoolStudentShared   = (Get-GroupByName "[EDU v2 Security] - $SchoolCode All Student Corporate Shared Android Tablet Devices").Id
}
...
"🎉 Completed Android Tablet Groups setup."
